...
interface IMapPathsInteractor {
    ...
    suspend fun getSavedCommonPath(pathId: Long, isOptimized: Boolean): MapCommonPath?
    ...
    suspend fun getSavedRatingPath(pathId: Long, withRatingOnly: Boolean, isOptimized: Boolean): MapRatingPath?
}
